		...
		<div class="row justify-content-center mt-3 mb-2">
			<div class="col-auto">
				<nav class="nav btn-group">
					<a href="#monthly" class="btn btn-outline-primary active" data-bs-toggle="tab">Đơn hàng Nhập</a>
															...
															<div class="col-md-12">
																<div class="card">
																	<div class="card-header">
																		<h5 class="card-title">PHIẾU NHẬP KHO</h5>
																		<h6>Thời gian: 
																			@php
																	...
																	<div class="card-body">
																			...
																			<div class="mb-3">
																				<label class="form-label" for="tenSP">Tổng số tiền: {{$order->total}} đ</label>
																			</div>
													...
													<div class="modal-dialog" role="document">
														<div class="modal-content">
															<div class="col-md-12">
																<div class="card">
																	<div class="card-header">
																		<h5 class="card-title">PHIẾU HỦY NHẬP KHO</h5>
																		<h6>Thời gian: 
																			@php
																				$date = $order->updated_at;
																				echo date_format($date, "d/m/Y");
